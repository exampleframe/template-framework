...
#    В данном степе используются составные элементы
    И пользователь нажимает кнопку "Купить" у элемента коллекции "Результаты", содержащего "Мышь беспроводная DEXP WM-1002BU черный"
#    В данном степе используется автоматическая генерация не описанного на странице элемента
    И пользователь нажимает кнопку "Добавить к сравнению" у элемента коллекции "Результаты", содержащего "Мышь беспроводная DEXP WM-1002BU черный"
    И стоп